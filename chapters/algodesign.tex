...
\begin{figure}
	...
	\hfill
	\subfloat[\label{subfig:rewrap1_target}Sample 1: Result of rewrap]{\input{figures/rewrap1_target.tex}}
	\\
	\subfloat[\label{subfig:rewrap2_source}Sample 2: Input data]{\input{figures/rewrap2_source.tex}}
	\hfill
	\subfloat[\label{subfig:rewrap2_target}Sample 2: Result of rewrap]{\input{figures/rewrap2_target.tex}}
	\\
	\subfloat[\label{subfig:rewrap3_source}Sample 3: Input data]{\input{figures/rewrap3_source.tex}}
	\hfill
	\subfloat[\label{subfig:rewrap3_target}Sample 3: Result of rewrap]{\input{figures/rewrap3_target.tex}}
\end{figure}
